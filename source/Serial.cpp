...
//I would like to add that this a good library to do play with your serial ports.
...
Serial::Serial(tstring &commPortName, int bitRate)//a reference is given as an argument so that copping do not occur which is a good practice in programming.
{
